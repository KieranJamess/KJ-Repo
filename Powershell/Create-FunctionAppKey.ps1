...
.EXAMPLE
    .\src\Create-FunctionAppAccesskey.ps1 -resourcegroupname "Resourcegroup" -FunctionAppName "myfunction" -keyname "TEST" -keyvalue "dsdsadsadsdsadsadasdsadsadasdsadsadsadadsds=="
#>
[CmdletBinding()]
Param (
